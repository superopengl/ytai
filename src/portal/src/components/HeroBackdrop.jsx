...
const DOODLE_ITEMS = [
  ...
  { kind: 'icon', node: <BulbOutlined />,          top: '14%', left: '17%',  size: 42, color: CREAM_PEACH, rotate: 8,   dur: 10.6, delay: 1.5 },
  ...
  { kind: 'icon', node: <StarFilled />,            top: '20%', right: '20%', size: 28, color: MINT,        rotate: 0,   dur: 7.6,  delay: 4.0 },
  // Mid band — sides only, central area stays empty for the headline / card.
  { kind: 'icon', node: <EditOutlined />,          top: '46%', left: '4%',   size: 50, color: PEACH,       rotate: -32, dur: 10.4, delay: 2.6 },
  { kind: 'sym',  char: '√',                       top: '58%', left: '13%',  size: 56, color: SAGE_DARK,   rotate: 4,   dur: 9.0,  delay: 0.4 },
  { kind: 'icon', node: <BookOutlined />,          top: '48%', right: '5%',  size: 54, color: MINT,        rotate: 14,  dur: 11.2, delay: 1.8 },
  ...
  { kind: 'icon', node: <StarFilled />,            bottom: '7%',  left: '24%', size: 26, color: CREAM_PEACH, rotate: 0,   dur: 8.0,  delay: 4.5 },
  { kind: 'icon', node: <ExperimentOutlined />,    bottom: '12%', right: '10%', size: 52, color: SAGE,       rotate: -16, dur: 10.8, delay: 2.9 },
  ...
  { kind: 'icon', node: <RocketOutlined />,        bottom: '30%', left: '3%',  size: 44, color: MAUVE,       rotate: -28, dur: 11.4, delay: 3.7 }
];
